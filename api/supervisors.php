...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    $stmt = $db->prepare(
        'SELECT s.id, s.first_name, s.last_name, s.email, s.phone, s.pin, s.ssn, s.salaxy_id, s.active,
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($id) {
        ...
        $db->prepare(
            'INSERT INTO supervisors (company_id, first_name, last_name, email, phone, pin, ssn, salaxy_id, active)
             VALUES (:cid, :fn, :ln, :email, :phone, :pin, :ssn, :salaxy_id, :active)'
        )->execute([
